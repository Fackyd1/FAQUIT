(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&t(r)}).observe(document,{childList:!0,subtree:!0});function l(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function t(s){if(s.ep)return;s.ep=!0;const i=l(s);fetch(s.href,i)}})();const v={BASE_URL:"/api"};function f(){return`
  ...
  `}function p({release:e}){var s;const a=e.github_url||`https://github.com/Fackyd1/${((s=e.title)==null?void 0:s.replace(/\s+/g,"-"))||"FAQUIT"}`,l=a.startsWith("http"),t=`
  ...
  `,requestAnimationFrame(()=>{document.querySelectorAll(".reveal").forEach((a,l)=>{a.style.transitionDelay=`${l*120}ms`,a.classList.add("is-visible")})}),setTimeout(()=>{const a=document.querySelector(".open-cv-btn");a&&a.addEventListener("click",l=>{l.preventDefault();const t=document.getElementById("cvModal");if(t){let r=function(){t.classList.remove("active"),document.body.style.overflow="",document.removeEventListener("keydown",o)},o=function(u){u.key==="Escape"&&r()};var s=r,i=o;t.classList.add("active"),document.body.style.overflow="hidden";const d=t.querySelector(".close-cv-btn"),n=t.querySelector(".cv-modal-backdrop");d.addEventListener("click",r),n.addEventListener("click",r),document.addEventListener("keydown",o)}})},100)}w();
