    ...
    <div class="page-shell">
      ...
      <section id="releases" class="section-block reveal">
        ...
        <div class="release-list">
          ${e.releases.map(a=>u({release:a})).join("")}
        </div>
      </section>
